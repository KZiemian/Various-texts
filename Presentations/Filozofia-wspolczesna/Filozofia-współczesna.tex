...
\mode<presentation>  % Rodzaj prezentacji Beamera
...
\begin{frame}
  ...
  \begin{block}{Złota zasada}
    \begin{figure}
      \centering \includegraphics[height=1.6in,
      width=1.3in]{Plato_Aristotle.jpg} \uncover<2->{\caption{Platon
          (427--347 BC), Arystoteles (384--322 BC)}}
    \end{figure}
  \end{block}
...
\begin{frame}
  ...
  \begin{block}{Kto jeszcze?}
    \begin{figure}
      ...
      \includegraphics[height=1.6in, width=1.9in]{Ludwig_von_Mises.jpg}
      \includegraphics[height=1.6in, width=1.2in]{Hans_Hermann_Hoppe.jpg}
      \includegraphics[height=1.6in, width=1.2in]{Bronislaw_Malinowski.jpg}
...
\begin{frame}
  ...
  \begin{block}{Utylitaryzm i pozytywizm}
    \begin{figure}
      ...
      \includegraphics[height=1.6in, width=1.2in]{John_Stuart_Mill.jpg}
...
\begin{frame}
  ...
  \begin{block}{Ameryka: transcendentalizm i pragmatyzm}
    \begin{figure}
      \centering \includegraphics[height=1.6in, width=1.2in]{HT}
...
\begin{frame}
  ...
  \begin{block}{}
    \begin{figure}
      ...
      \includegraphics[height=1.6in, width=1.3in]{Emanuel_Swedenborg.png}
...
\begin{frame}
  ...
  \begin{block}{Romantyk wygląda tak}
    \begin{figure}
      ...
      \includegraphics[height=1.3in, width=1.1in]{CF} \pause
