...
\item Obiekty zamknięte w środowiskach float np.~wykresy
  ...
  W~pewnych wypadkach, w~szczególności mniej istotnych wykresów, które mają tylko zilustrować ogólne zachowanie badanego zjawiska, dobrze jest umieścić rysunek zajmujący nie całą stronę, lecz
\end{enumerate}
...
\item \emph{\TeX{} Users Group},
  \href{http://tug.org/}{http://tug.org/}. \\
  Wielkie źródło na~temat typografii.
\end{enumerate}
