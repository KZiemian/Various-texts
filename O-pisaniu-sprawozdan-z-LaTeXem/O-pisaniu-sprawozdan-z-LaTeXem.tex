...
\begin{figure}
  ...
  \begin{tikzpicture}
    ...
    % Axes
    \draw[help lines, black, ->] (0, 0) -- (1.15*\radius, 0);
    ...
    \begin{scope}[very thick, decoration={
      ...
      \draw[postaction={decorate}] (0, 0) -- (\radius, 0);
      \draw[postaction={decorate}] (\radius, 0) arc (0:90:\radius);
      \draw[postaction={decorate}] (0, \radius) -- (0, 0);
    \end{scope}

    % The labels
    \node at (0, -0.25){$0$};

    \node at (4.6, -0.3){$\mathfrak{Re}\, z$}; \node at (-0.55,
    4.6){$\mathfrak{Im}\, z$};

    \node at (0.5*\radius, -0.5){$\gamma_{ 1 }$}; \node at (-0.4,
