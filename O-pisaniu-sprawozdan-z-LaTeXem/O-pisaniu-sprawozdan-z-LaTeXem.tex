...
\item Istnieje wiele edytorów dedykowanych do~\LaTeX a, takich choćby
  jak \TeX Maker, jednak można również używać go~online dzięki stronom takim jak
  \href{https://www.overleaf.com/}{Overleaf}. Jeśli zaczynasz swoją znajomość z~\LaTeX
...
\item Tak samo między wartością liczbową, a~jednostką powinien być
  ...
  Wyjątek w~języku polskim\footnote{Czy istnieje coś w~języku polskim
    od~czego nie ma wyjątków?} od~tej reguły stanową stopnie Celsjusza
